...
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			jsono.put("name", "DSCI0138.JPG"); // 文件名称
			jsono.put("size", 1023); // 文件大小
			jsono.put("url", "DSCI0138.JPG");
			jsono.put("image", "DSCI0138.JPG");
			jsono.put("thumbnailUrl", "DSCI0138.JPG");

			jsono.put("deleteUrl", "upload?file=" + "DSCI0138.JPG");
